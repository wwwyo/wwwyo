...
import DrlDemo from "../../components/embeds/DrlDemo";
import WebGpuGradientDemo from "../../components/embeds/WebGpuGradientDemo";
import WebGpuSolidDemo from "../../components/embeds/WebGpuSolidDemo";
...
<img
  ...
  style="max-width: 24rem; width: 100%; border: 1px solid var(--border); border-radius: var(--rounded-code);"
/>
